    ...
    is IncomingSMMobileMethodCall.SetScheduleFromAC -> IncomingEvent.SetScheduleFromAC(
        ...
        programSetting = IncomingEvent.SetScheduleFromAC.ProgramSetting(
            sunday = IncomingEvent.SetScheduleFromAC.ProgramSetting.Program(
                p1 = ProgramEntry.from(unparsedCall.payload.programSetting.Sunday.p1),
                p2 = ProgramEntry.from(unparsedCall.payload.programSetting.Sunday.p2),
                p3 = ProgramEntry.from(unparsedCall.payload.programSetting.Sunday.p3),
                p4 = ProgramEntry.from(unparsedCall.payload.programSetting.Sunday.p4),
            ),
            monday = IncomingEvent.SetScheduleFromAC.ProgramSetting.Program(
                p1 = ProgramEntry.from(unparsedCall.payload.programSetting.Monday.p1),
                p2 = ProgramEntry.from(unparsedCall.payload.programSetting.Monday.p2),
                p3 = ProgramEntry.from(unparsedCall.payload.programSetting.Monday.p3),
                p4 = ProgramEntry.from(unparsedCall.payload.programSetting.Monday.p4),
            ),
            tuesday = IncomingEvent.SetScheduleFromAC.ProgramSetting.Program(
                p1 = ProgramEntry.from(unparsedCall.payload.programSetting.Tuesday.p1),
                p2 = ProgramEntry.from(unparsedCall.payload.programSetting.Tuesday.p2),
                p3 = ProgramEntry.from(unparsedCall.payload.programSetting.Tuesday.p3),
                p4 = ProgramEntry.from(unparsedCall.payload.programSetting.Tuesday.p4),
            ),
            wednesday = IncomingEvent.SetScheduleFromAC.ProgramSetting.Program(
                p1 = ProgramEntry.from(unparsedCall.payload.programSetting.Wednesday.p1),
                p2 = ProgramEntry.from(unparsedCall.payload.programSetting.Wednesday.p2),
                p3 = ProgramEntry.from(unparsedCall.payload.programSetting.Wednesday.p3),
                p4 = ProgramEntry.from(unparsedCall.payload.programSetting.Wednesday.p4),
            ),
            thursday = IncomingEvent.SetScheduleFromAC.ProgramSetting.Program(
                p1 = ProgramEntry.from(unparsedCall.payload.programSetting.Thursday.p1),
                p2 = ProgramEntry.from(unparsedCall.payload.programSetting.Thursday.p2),
                p3 = ProgramEntry.from(unparsedCall.payload.programSetting.Thursday.p3),
                p4 = ProgramEntry.from(unparsedCall.payload.programSetting.Thursday.p4),
            ),
            friday = IncomingEvent.SetScheduleFromAC.ProgramSetting.Program(
                p1 = ProgramEntry.from(unparsedCall.payload.programSetting.Friday.p1),
                p2 = ProgramEntry.from(unparsedCall.payload.programSetting.Friday.p2),
                p3 = ProgramEntry.from(unparsedCall.payload.programSetting.Friday.p3),
                p4 = ProgramEntry.from(unparsedCall.payload.programSetting.Friday.p4),
            ),
            saturday = IncomingEvent.SetScheduleFromAC.ProgramSetting.Program(
                p1 = ProgramEntry.from(unparsedCall.payload.programSetting.Saturday.p1),
                p2 = ProgramEntry.from(unparsedCall.payload.programSetting.Saturday.p2),
                p3 = ProgramEntry.from(unparsedCall.payload.programSetting.Saturday.p3),
                p4 = ProgramEntry.from(unparsedCall.payload.programSetting.Saturday.p4),
            ),
        ),
